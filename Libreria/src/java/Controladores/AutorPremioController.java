...
public class AutorPremioController implements Serializable {
    ...
    public AutorPremio getSelected() {
        if (current == null) {
            ...
            current.setAutorPremioPK(new Libreria.AutorPremioPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public AutorPremio getAutorPremio(Libreria.AutorPremioPK id) {
    ...
    public static class AutorPremioControllerConverter implements Converter {
        ...
        Libreria.AutorPremioPK getKey(String value) {
            Libreria.AutorPremioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new Libreria.AutorPremioPK();
        ...
        String getStringKey(Libreria.AutorPremioPK value) {
